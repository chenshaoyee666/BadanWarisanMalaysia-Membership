...
const dummyEvents: Event[] = [
  ...
  },
  {
    ...
    description: 'Journey through 600 years of history in Malaysia\'s UNESCO World Heritage Site. This comprehensive day tour covers the Portuguese, Dutch, and British colonial periods that shaped this fascinating city.\n\nVisit A Famosa fort, St. Paul\'s Church, Christ Church, and the Baba Nyonya Heritage Museum. Experience the unique blend of Malay, Chinese, Indian, and European influences that make Malacca truly one-of-a-kind.',
